  ...
  const onLogout = () => {
    Alert.alert('Log out', 'You will be signed out of this device.', [
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        style: 'destructive',
        onPress: async () => {
          // Clear tokens + all stores first, otherwise the AuthGuard sees a
          // still-authenticated session and bounces straight back to Home.
          await resetAllStores();
          // Land on "Create Your Account" (login) — same as the sales logout.
