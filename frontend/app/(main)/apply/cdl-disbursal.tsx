...
export default function CdlDisbursalScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="Disbursal" showBack />
      {loading || !status ? (
        <View style={styles.center}>
          <LoadingSpinner size={42} color={Colors.primary} />
          <Text style={styles.loadingText}>Processing Razorpay payout to the merchant…</Text>
        </View>
      ) : (
        <>
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            <View style={styles.successCard}>
              ...
              <Text style={styles.subtitle}>Paid to {status.merchantName}</Text>
            </View>
            ...
            <View style={styles.losBox}>
              ...
              <Text style={styles.losText}>
                Loan origination complete. Your loan account is now active with a {tenure}-month EMI schedule.
              </Text>
            </View>
          </ScrollView>
